...
#define NOTES_BASE "Vos notes par rapport à ce que l'on pert dans le programme une fois sur l'autre !\n\n" \
                   ...
                   "	------------\n\n" \
                   "Vous utilisez la version " + QString::number(VERSION) + " de ce programme.\n" \
...
// On affiche le message d'à propos
    QMessageBox::about(zoneCentrale, "A propos de NaheulBeuk Helper",
                       ...
                       "Vous utilisez la version " + QString::number(VERSION) + ".\n\n"
                       "Le lecteur d'aide est basé sur zNavigator, le navigateur des zéros, fait dans un TP disponible sur le site du zéro.\n\n"
                       "Ce programme est développé en C++, avec QtCreator et utilise a bibliothèque graphique open source Qt.");
}
